# Matplotlib Interactive Cheat Sheets

Matplotlib Interactive Cheat Sheets are Jupyter Notebooks which contains Python code snippets so this track needs primarily knowledge of the Python Programming Language which can be found [here](https://github.com/mhmaem/python_university/tree/master/01_python_beginner_interactive_cheatsheets) 
